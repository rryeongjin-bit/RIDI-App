...
from test_app.test_platform.AppPlatform import PlatformType
...
def open_app(app_type: Enum, platform: str, device_name: str, port: int):
    ...
    if platform == PlatformType.ANDROID:
        apk_path =  r"C:\Users\User\Downloads\RIDI-25.113.3-Playstore.apk"
        ...
        ipa_path =  r"C:\Users\User\Downloads\Ridibooks for Appium.app"  
